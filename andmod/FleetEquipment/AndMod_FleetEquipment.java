...
@Mod(
		modid	= "AndanteMod_FleetEquipment",
		name	= "FleetEquipment",
		version	= "1.6.2.0",
...
public class AndMod_FleetEquipment {
	...
	public int aitemIDdefault = 24158;

	public static String ObjectHeader = "FleetEquipment:";

	private int fm = OreDictionary.WILDCARD_VALUE;

	
	@Mod.Instance( "AndanteMod_FleetEquipment" )
	public static AndMod_FleetEquipment instance;
	...
	public void preInit( FMLPreInitializationEvent event ) {
		...
		id++;
		aitemname[id][0] = "61cmQuintO2Torpedo";
		aitemname[id][1] = "61cm Quint O2 Torpedo Mount";
		aitemname[id][2] = "61cm五連装(酸素)魚雷";
	...
	public void init( FMLInitializationEvent event ) {
		...
		id ++;
		if ( aitemID[id] != 0 ) {
			aitem[id] = new Item_Torpedo( aitemID[id], 5 ).setParameters( 1.0, 1.0, 1.0, 0.001, ObjectHeader.toLowerCase() + "textures/entity/" + aitemname[id][0].substring( ObjectHeader.length() ) + ".png" )
			.setResistance( 0.6, 1.2 )
			.addEffect( Struct_Arrow.EFFECT_EXPLOSION, 5, 0, 1.0F )

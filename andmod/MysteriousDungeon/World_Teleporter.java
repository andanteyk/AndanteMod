...
public class World_Teleporter extends Teleporter {
	...
	public World_Teleporter( WorldServer ws ) {
		super( ws );
		this.worldObj = ws;
	...
	@Override
	public void placeInPortal( Entity entity, double px, double py, double pz, float rotation ) {
		if ( !placeInExistingPortal( entity, px, py, pz, rotation ) ) {
			makePortal( entity );
			placeInExistingPortal( entity, px, py, pz, rotation );
		}
	}
	...
	@Override
	public boolean placeInExistingPortal( Entity entity, double px, double py, double pz, float rotation ) {
		short var1 = 128;
		double var2 = -1.0D;
		int x = 0;
		int y = 0;
		...
		{
		if (worldObj.getBlockId(var8, var15, var13) == AndMod_MysteriousDungeon.getBlockID( "MysteriousDungeonPortal" ) )
		{
		while (worldObj.getBlockId(var8, var15 - 1, var13) == AndMod_MysteriousDungeon.getBlockID( "MysteriousDungeonPortal" ) )
		{
		--var15;
		}
		...
		if (worldObj.getBlockId(x - 1, y, z) == AndMod_MysteriousDungeon.getBlockID( "MysteriousDungeonPortal" ) )
		{
		var14 = 2;
		}
		...
		if (worldObj.getBlockId(x, y, z - 1) == AndMod_MysteriousDungeon.getBlockID( "MysteriousDungeonPortal" ) )
		{
		var14 = 3;
		}
	...
	public boolean makePortal(Entity entity) {
		...
		worldObj.setBlock(var19, var18, var21, flag ? Block_Portal.frameID: 0, 0, 2);
		}
		}
		}
		}
		...
		worldObj.setBlock(var19, var18, var21, flag ? Block_Portal.frameID : AndMod_MysteriousDungeon.getBlockID( "MysteriousDungeonPortal" ), 0, 2);
		}
		}
